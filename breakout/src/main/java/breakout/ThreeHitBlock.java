...
public class ThreeHitBlock extends Block{
  ...
  private int numberOfHitsLeft = 3;
  private final String WALL = "/"+ "ThreeHitBlock3.png";
  private Image singleCrack;
  private Image doubleCrack;


  public ThreeHitBlock(int x, int y) {
    Image wallImage = new Image(getClass().getResourceAsStream(WALL));
    singleCrack = new Image(getClass().getResourceAsStream("/ThreeHitBlock2.png"));
    doubleCrack = new Image(getClass().getResourceAsStream("/ThreeHitBlock1.png"));
  ...
  public void update() {
    if(numberOfHitsLeft == 2)
      myBlock.setImage(doubleCrack);
